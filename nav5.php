<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0">
        ...
        <!-- ================= Favicon ================== -->
        <!-- Standard -->
        <link rel="shortcut icon" href="https://ogiebooks.gq/img/logo.ico">
        <!-- Retina iPad Touch Icon-->
        <link rel="apple-touch-icon" sizes="144x144" href="https://ogiebooks.gq/img/logo.ico">
        <!-- Retina iPhone Touch Icon-->
        <link rel="apple-touch-icon" sizes="114x114" href="https://ogiebooks.gq/img/logo.ico">
        <!-- Standard iPad Touch Icon--> 
        <link rel="apple-touch-icon" sizes="72x72" href="https://ogiebooks.gq/img/logo.ico">
        <!-- Standard iPhone Touch Icon--> 
        <link rel="apple-touch-icon" sizes="57x57" href="https://ogiebooks.gq/img/logo.ico">
    ...
    <link rel="stylesheet" href="https://ogiebooks.gq/css/material.css">
    <link rel="stylesheet" href="css/_carousel.scss">
    <link rel="stylesheet" href="css/dialog-polyfill.scss">
    <link rel="stylesheet" href="https://ogiebooks.gq/css/styles.css">
    <link rel="stylesheet" href="https://ogiebooks.gq/css/mdl-selectfield.min.css">
    ...
    <script src="https://ogiebooks.gq/js/material.js"></script>
    <script src="https://ogiebooks.gq/js/mdl-selectfield.min.js"></script>
