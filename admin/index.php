...
if(isset($_POST['delete'])) {
    ...
    mysqli_query($con, "DELETE FROM '".$row['form']."' WHERE `key` = '".$_POST['delete']."'");
...
<?php $page = 'admin.php'; include('nav.php'); 
...
<?php   while($row = mysqli_fetch_array($result)) { 
  ...
  ?>
        ...
        <input name="form" type="hidden" value="<?php echo $row['form']?>">
              ...
              <input type="hidden" name="form" value="Norway">
...
<p class="card1" style="color: white; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 17px;">No ads posted yet by any users.</a></p>

  <?php } else {  $errorinfo = 'Please sign in to your admin account. Thanks.'; ?>
    <p style="color: white; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 17px;">Please sign in to your admin account. <a href="login.php">You can sign in here.</a></p>
  <?php } ?>
</div>
