...
$timeouttime = time() - $_SESSION['timeout'];
  ...
  if(!empty($_SESSION['stayloggedin'])) {
    if($_SESSION['stayloggedin'] < time()) {
     ...
     session_destroy(); unset($_SESSION['usr_id2']); unset($_SESSION['usr_name']); unset($_SESSION['stayloggedin']); header("Location: index.php");

    }
  } else {
      if ($timeouttime > 1800) {
        session_destroy(); unset($_SESSION['usr_id2']); unset($_SESSION['usr_name']); header("Location: index.php");
    ...
    <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
      ...
      <div class="banasell-drawer mdl-layout__drawer" >
        <span class="mdl-layout-title"  style="line-height: 1em !important">
          ...
          <br></br>
          <span><?php if(isset($_SESSION['usr_id2'])) { echo $_SESSION['usr_name']; } else { echo 'Ogiebooks'; } ?></span>
        </span>
